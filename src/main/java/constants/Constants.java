...
public class Constants {
  ...
  public static final String CREATE_BUS_STATUS_TABLE = "CREATE TABLE BUS_STATUS(BUS_STATUS_ID NUMBER GENERATED ALWAYS AS IDENTITY, "
  		+ "BUS_ID NUMBER REFERENCES BUS(BUS_ID) NOT NULL, "
  		+ "BUS_DATE DATE, "
  		+ "BOOKED_SEATS NUMBER, "
  		+ "AVAILABLE_SEATS NUMBER NOT NULL, "
  		+ "WAIT_LISTED_SEATS NUMBER, PRIMARY KEY (BUS_STATUS_ID))";
}
